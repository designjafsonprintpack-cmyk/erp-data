      ...
      <Section title="Product Specifications">
        <div className="grid grid-cols-4 gap-4">
          ...
          <div className="space-y-1.5">
            ...
            <select className={inputCls} value={form.board_type_id} onChange={e => set('board_type_id', e.target.value)}>
          ...
          <div className="space-y-1.5">
            ...
            <select className={inputCls} value={form.paper_type_id} onChange={e => set('paper_type_id', e.target.value)}>
      ...
      <Section title="Finishing">
        <div className="grid grid-cols-4 gap-4">
          ...
          <div className="space-y-1.5">
            ...
            <input className={inputCls} value={form.pasting} onChange={e => set('pasting', e.target.value)} placeholder="e.g. Auto, Manual" />
          </div>
          <div className="space-y-1.5">
          ...
          <div className="col-span-4 flex items-center gap-3">
            <label className="flex items-center gap-2 cursor-pointer">
              <input type="checkbox" checked={form.uv_coating} onChange={e => set('uv_coating', e.target.checked)}
                className="w-4 h-4 rounded border-[var(--color-border)]" />
              <span className="text-sm text-[var(--color-text-primary)]">UV Coating</span>
            </label>
          </div>
        </div>
      </Section>
