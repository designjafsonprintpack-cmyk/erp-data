...
export default function HotFoilPage() {
  return (
    <div className="space-y-5">
      <PageHeader title="Hot Foil" subtitle="Jobs ready for foil stamping" />
      <StageQueueClient stageSlug="hot-foil" stageLabel="Hot Foil" />
    </div>
  )
}
