...
export default function FolderGluingPage() {
  return (
    <div className="space-y-5">
      <PageHeader title="Folder Gluing" subtitle="Jobs ready for gluing and pasting" />
      <StageQueueClient stageSlug="folder-gluing" stageLabel="Folder Gluing" />
    </div>
  )
}
