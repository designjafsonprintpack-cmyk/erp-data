...
const navItems = [
  ...
  { label: 'Store', href: '/dashboard/store', icon: Package, color: '#84cc16' },
  ...
  { label: 'Printing', href: '/dashboard/production/printing', icon: BarChart3, color: '#f43f5e' },
  { label: 'Lamination', href: '/dashboard/production/lamination', icon: BarChart3, color: '#fb923c' },
  { label: 'Die Cutting', href: '/dashboard/production/die-cutting', icon: BarChart3, color: '#facc15' },
  { label: 'Hot Foil', href: '/dashboard/production/hot-foil', icon: BarChart3, color: '#fbbf24' },
  { label: 'Folder Gluing', href: '/dashboard/production/folder-gluing', icon: BarChart3, color: '#fb7185' },
...
type NavItem = { label: string; href: string; icon: React.ComponentType<{size?: number; className?: string; style?: React.CSSProperties}>; color: string } | { divider: true; label: string }
